          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }} className="contact-grid">
            ...
            <div className="reveal-right delay-1">
              <div style={{
                ...
                <h3 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '24px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: '#e8f0f0', marginBottom: '12px' }}>
                  Send Us an Email
                </h3>
                <p style={{ fontSize: '14px', color: '#4a4a78', lineHeight: 1.8, marginBottom: '32px' }}>
                  Click the button below and a new email draft will open addressed directly to us. Just type your message and hit send.
                </p>
                <a
                  href="mailto:skthunderrobotics@gmail.com?subject=Partnership Inquiry — Thunder Robotics"
                  style={{
                    display: 'block', width: '100%', boxSizing: 'border-box',
                    background: '#00b3b3', color: '#05050f',
                    fontFamily: 'Barlow Condensed, sans-serif', fontSize: '18px', fontWeight: 700,
                    letterSpacing: '0.1em', textTransform: 'uppercase',
                    padding: '18px 24px', textAlign: 'center', textDecoration: 'none',
                ...
                <p style={{ fontSize: '12px', color: '#2e2e55', marginTop: '14px' }}>
