  ...
  return (
    <>
      ...
      <section style={{
        ...
        position: 'relative',
        overflow: 'hidden',
        background: 'linear-gradient(135deg, #141338 60%, #1a1940 100%)',
      }}>
        {/* Background grid */}
        <div style={{
          position: 'absolute',
          inset: 0,
          backgroundImage: `
            linear-gradient(rgba(0,179,179,0.04) 1px, transparent 1px),
            linear-gradient(90deg, rgba(0,179,179,0.04) 1px, transparent 1px)
          `,
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, paddingTop: '100px' }}>
          <div style={{ maxWidth: '800px' }}>
            ...
            <h1 className="animate-fade-up delay-2" style={{
              ...
              Where<br />
              <span style={{ color: '#00b3b3' }}>Innovation</span><br />
              Meets<br />
              Competition.
            </h1>
            ...
            <div className="animate-fade-up delay-4" style={{ marginTop: '40px', display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              ...
              <a href="#contact" className="btn" style={{ borderColor: 'rgba(232,240,240,0.2)', color: '#f5f6f0' }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '12px', letterSpacing: '0.15em', color: '#4a4980', textTransform: 'uppercase' }}>Scroll</span>
          <div style={{
            width: '1px',
            height: '50px',
            background: 'linear-gradient(to bottom, rgba(0,179,179,0.6), transparent)',
      ...
      {/* ═══════════════════════════════════ ABOUT ═══════════════════════════════════ */}
      <section id="about" className="section" style={{ background: '#181740' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
            <div>
              ...
              <p className="reveal delay-2" style={{ color: '#7a79a0', lineHeight: 1.8, marginBottom: '24px' }}>
              ...
              <p className="reveal delay-3" style={{ color: '#7a79a0', lineHeight: 1.8 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              {[
                ...
                <div
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.borderColor = 'rgba(0,179,179,0.4)'
                ...
                >
                  ...
                  <p style={{ fontSize: '14px', color: '#4a4980', lineHeight: 1.7 }}>{card.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div style={{ maxWidth: '600px' }}>
            ...
            <div style={{ width: '60px', height: '3px', background: '#141338', marginBottom: '28px' }} className="reveal delay-2" />
            ...
            <a href="#teams" className="reveal delay-3" style={{
              ...
              textTransform: 'uppercase',
              color: '#141338',
              border: '2px solid #141338',
              padding: '14px 32px',
              transition: 'background 0.3s ease, color 0.3s ease',
            }}
            onMouseEnter={e => { e.currentTarget.style.background = '#141338'; e.currentTarget.style.color = '#00b3b3'; }}
            onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = '#141338'; }}
            >
              Learn More →
            </a>
          </div>
      ...
      {/* ═══════════════════════════════════ STATS ═══════════════════════════════════ */}
      <section style={{ background: '#141338', padding: '100px 0' }}>
        <div className="container">
          ...
          <div style={{
            ...
            {[
              ...
              <div
                ...
                onMouseEnter={e => {
                  e.currentTarget.style.borderBottomColor = '#00b3b3'
                  e.currentTarget.style.background = '#1a1940'
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.borderBottomColor = 'transparent'
                  e.currentTarget.style.background = '#141338'
                }}
              >
                <div style={{
                  fontFamily: 'Barlow Condensed, sans-serif',
      ...
      {/* ═══════════════════════════════════ TEAMS ═══════════════════════════════════ */}
      <section id="teams" className="section" style={{ background: '#181740' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '64px' }}>
      ...
      {/* ═══════════════════════════════════ SPONSORS ═══════════════════════════════════ */}
      <section id="sponsors" className="section" style={{ background: '#141338' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '64px' }}>
          ...
          <div style={{
            ...
            {['Partner 1', 'Partner 2', 'Partner 3', 'Partner 4', 'Partner 5'].map((p, i) => (
              <div
                ...
                onMouseEnter={e => e.currentTarget.style.background = '#1a1940'}
                onMouseLeave={e => e.currentTarget.style.background = '#141338'}
              >
                <div style={{
                  fontFamily: 'Barlow Condensed, sans-serif',
                  fontSize: '20px',
                ...
                onMouseLeave={e => e.target.style.color = '#2e2d6e'}
                >{p}</div>
              </div>
            ))}
          </div>
      ...
      <section id="contact" style={{
        background: '#1a1940',
        borderTop: '1px solid rgba(0,179,179,0.15)',
        borderBottom: '1px solid rgba(0,179,179,0.15)',
        padding: '100px 0',
      }}>
        ...
        <div className="container">
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '14px', color: '#4a4980', lineHeight: 1.7, marginBottom: '16px' }}>
                St. Kateri Thunder Robotics Team<br />
                Where Innovation Meets Competition.
              </p>
              <p style={{ fontSize: '14px', color: '#4a4980' }}>905-634-1835</p>
              <p style={{ fontSize: '14px', color: '#4a4980' }}>1125 Kennedy Circle East</p>
              <p style={{ fontSize: '14px', color: '#4a4980' }}>Milton ON L9E 1B4</p>
            </div>
            ...
            <div>
              ...
              {['Vision', 'Programs', 'Blog', 'Get Started'].map(l => (
                ...
                onMouseLeave={e => { e.target.style.color = '#4a4980'; e.target.style.paddingLeft = '0'; }}
                >{l}</a>
              ))}
            </div>
            ...
            <div>
              ...
              <p style={{ fontSize: '14px', color: '#4a4980', marginBottom: '16px', lineHeight: 1.7 }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '13px', color: '#2e2d6e' }}>
