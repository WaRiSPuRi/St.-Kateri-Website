...
function ContactForm() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href = `mailto:skthunderrobotics@gmail.com?subject=${subject}&body=${body}`
    setSent(true)
  }
  ...
  if (sent) return (
    <div style={{ textAlign: 'center', padding: '40px 0' }}>
      ...
      <p style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '20px', color: '#00b3b3', fontWeight: 700 }}>Email client opened!</p>
      <p style={{ fontSize: '14px', color: '#3a3a60', marginTop: '8px' }}>Send the email in your mail app to reach us.</p>
    </div>
  )
