  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        letterSpacing: '0.2em', textTransform: 'uppercase', color: '#7070a0', marginTop: '14px',
      }}>{label}</div>
    </div>
  )
}
    ...
    <>
      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, paddingTop: '110px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: '60px', alignItems: 'center' }} className="hero-grid">
            <div style={{ maxWidth: '780px' }}>
              ...
              <p className="animate-fade-up delay-3" style={{ marginTop: '36px', fontSize: '18px', color: '#8888b0', maxWidth: '460px', lineHeight: 1.8 }}>
        ...
        <div className="animate-fade-in delay-6" style={{
          ...
          <span style={{ fontSize: '11px', letterSpacing: '0.2em', color: '#6060a0', textTransform: 'uppercase' }}>Scroll</span>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }} className="about-grid">
            <div>
              ...
              <p className="reveal-left delay-2" style={{ color: '#8888b0', lineHeight: 1.85, marginBottom: '20px' }}>
              ...
              <p className="reveal-left delay-3" style={{ color: '#8888b0', lineHeight: 1.85 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
              {[
                ...
                >
                  ...
                  <p style={{ fontSize: '13px', color: '#7070a0', lineHeight: 1.75 }}>{card.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{
            ...
            >
              ...
              <div style={{
                ...
                letterSpacing: '0.15em', textTransform: 'uppercase', color: '#7070a0', marginTop: '10px',
      ...
      <section id="sponsors" className="section" style={{ background: '#05050f', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div className="reveal-scale delay-2" style={{ maxWidth: '680px', margin: '0 auto' }}>
            ...
            >
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ color: '#7070a0', lineHeight: 1.85, maxWidth: '420px', fontSize: '15px' }}>
          ...
          <p className="reveal delay-4" style={{ textAlign: 'center', marginTop: '40px', fontSize: '14px', color: '#6060a0', fontStyle: 'italic' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }} className="contact-grid">
            ...
            <div>
              ...
              <div className="section-line reveal-left delay-2" />
              <p className="reveal-left delay-2" style={{ color: '#8888b0', lineHeight: 1.85, marginBottom: '32px' }}>
              ...
              <div className="reveal-left delay-3" style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                {[
                  ...
                  <div key={item.label} style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
                    ...
                    <div>
                      <div style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '12px', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#7070a0', marginBottom: '2px' }}>{item.label}</div>
                      {item.href
                        ? <a href={item.href} style={{ fontSize: '15px', color: '#e8f0f0', transition: 'color 0.2s ease' }}
                          ...
                          >{item.value}</a>
                        : <span style={{ fontSize: '15px', color: '#8888b0' }}>{item.value}</span>
                      }
                    </div>
                  </div>
                ))}
            ...
            <div className="reveal-right delay-1">
              <div style={{
                ...
                <h3 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '22px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: '#e8f0f0', marginBottom: '8px' }}>
                  Reach Out
                </h3>
                <p style={{ fontSize: '14px', color: '#7a7a9a', lineHeight: 1.75, marginBottom: '28px' }}>
                  Pick whichever way works best for you.
                </p>

                {/* Option 1 — window.open mailto */}
                <button
                  onClick={() => window.open('mailto:skthunderrobotics@gmail.com?subject=Partnership Inquiry — Thunder Robotics', '_blank')}
                  style={{
                ...
                <p style={{ fontSize: '13px', color: '#7070a0', textAlign: 'center' }}>
                  ...
                  <span style={{ color: '#00b3b3', fontWeight: 600 }}>skthunderrobotics@gmail.com</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '48px', marginBottom: '56px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '14px', color: '#7070a0', lineHeight: 1.75, marginBottom: '16px' }}>
                St. Kateri Thunder Robotics Team<br />Where Innovation Meets Competition.
              </p>
              <p style={{ fontSize: '14px', color: '#6060a0' }}>905-634-1835</p>
              <p style={{ fontSize: '14px', color: '#6060a0' }}>1125 Kennedy Circle East</p>
              <p style={{ fontSize: '14px', color: '#6060a0' }}>Milton ON L9E 1B4</p>
            </div>
            ...
            <div>
              ...
              {['About', 'Sponsors', 'Contact'].map(l => (
                <a key={l} href={`#${l.toLowerCase()}`} style={{
                  display: 'block', fontSize: '14px', color: '#6060a0', marginBottom: '10px',
                  transition: 'color 0.2s ease, padding-left 0.2s ease',
                }}
                onMouseEnter={e => { e.target.style.color='#e8f0f0'; e.target.style.paddingLeft='6px'; }}
                onMouseLeave={e => { e.target.style.color='#6060a0'; e.target.style.paddingLeft='0'; }}
                >{l}</a>
              ))}
            </div>
            ...
            <div>
              ...
              <a href="tel:9056341835" style={{ display: 'block', fontSize: '14px', color: '#6060a0', transition: 'color 0.2s ease' }}
              onMouseEnter={e => e.target.style.color='#00b3b3'}
              onMouseLeave={e => e.target.style.color='#6060a0'}
              >905-634-1835</a>
            </div>
          ...
          <div style={{
            ...
            <p style={{ fontSize: '13px', color: '#5050a0' }}>© 2025 St. Kateri Thunder Robotics Team. All rights reserved.</p>
            <div style={{ display: 'flex', gap: '20px' }}>
              {['Twitter/X', 'Instagram', 'LinkedIn'].map(s => (
                <a key={s} href="#" style={{ fontSize: '13px', color: '#5050a0', transition: 'color 0.2s ease' }}
                onMouseEnter={e => e.target.style.color='#00b3b3'}
                onMouseLeave={e => e.target.style.color='#5050a0'}
                >{s}</a>
              ))}
            </div>
          </div>
...
function CopyEmail() {
  ...
  const email = 'skthunderrobotics@gmail.com'
  ...
  return (
    <button
      ...
      style={{
        ...
        border: '1px solid rgba(0,179,179,0.35)', color: '#00b3b3',
        fontFamily: 'Barlow Condensed, sans-serif', fontSize: '17px', fontWeight: 700,
        letterSpacing: '0.08em', textTransform: 'uppercase',
        padding: '17px 22px', cursor: 'pointer',
        transition: 'background 0.2s ease, border-color 0.2s ease',
      }}
      onMouseEnter={e => { e.currentTarget.style.background='rgba(0,179,179,0.08)'; e.currentTarget.style.borderColor='rgba(0,179,179,0.7)' }}
      onMouseLeave={e => { e.currentTarget.style.background='transparent'; e.currentTarget.style.borderColor='rgba(0,179,179,0.35)' }}
    >
