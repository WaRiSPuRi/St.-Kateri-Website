  ...
  return (
    <>
      <nav style={{
        ...
        borderBottom: scrolled ? '1px solid rgba(245,200,0,0.15)' : '1px solid transparent',
        ...
        <div style={{ padding: '24px' }}>
          {links.map((l, i) => (
            <Link
              ...
              onMouseEnter={e => { e.target.style.color = '#f5c800'; e.target.style.transform = 'translateX(8px)'; }}
